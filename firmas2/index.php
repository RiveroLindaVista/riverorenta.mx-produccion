...
<body>
  ...
  <script>
    ...
    const usuario = "juan";
    const accion = "ver";
    const url = `http://www.google.com/calendar/event?action=TEMPLATE&dates=20251031T11:00:00-01:00/20251031T12:00:00-01:00&text=Taller+Cita+de+Servicio&location=Av.Miguel+Aleman+5400&details=Cita+en+taller+de+servicio+para+tu+Aveo+2020+en+Rivero+Linda+Vista&usuario=${usuario}&accion=${accion}`;
