...
function constructByAgency($data, $agency, $link)
{
    ...
    $tx .= '<h5  style=\'margin: 0px; color: white;\'>UNIDADES FALTANTES DE MOCKUPS (<span style=\'color: red;\'>1200 x 485</span>)</h5> <ul style=\'margin: 0px; color: white;\'>' . ($tx_without_colors == '' ? '---': $tx_without_colors) . '</ul>';
    $tx .= '<h5  style=\'margin: 0px; color: white;\'>UNIDADES FALTANTES DE FONDOS Y CAPAS (<span style=\'color: red;\'>2740 x 1738</span>) </h5> <ul style=\'margin: 0px; color: white;\'>' . ($tx_without_fondo == '' ? '---': $tx_without_fondo) . '</ul>';
