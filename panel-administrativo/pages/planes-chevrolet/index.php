<?php  
	...
	$sql = 'SELECT * FROM catalogo WHERE ano IN("2022","2023","2024","2025") AND marca="CHEVROLET" GROUP BY modelo,ano ORDER BY modelo asc';
...
<body class="theme-blue">
   ...
   <?php include('../../_inc/_search-bar.php');?>
    ...
    <script>
        function gopage($i){
            location.href="<?=URLP?>pages/detalles-planes-chevrolet/index.php?id="+$i;
        }
    </script>
