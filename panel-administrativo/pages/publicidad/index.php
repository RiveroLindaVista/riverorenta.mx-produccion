...
$conne = new Construir();
$get_publicidad = $conne->get_table_publicidad();


$this_page = "publicidad";
if ($this_page=="publicidad") { $publicidad="active"; } else{ $publicidad="active"; }
?>
<!DOCTYPE html>
<html>
<head>
...
<script>
  ...
  function cambiarStatus(obj){
  var r = confirm("Estás apunto de eliminar este artículo, ¿Estás seguro de continuar?");
  if (r == true) {
   obj=obj;
        var param={
                obj:obj
