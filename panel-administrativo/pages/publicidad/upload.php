...
$location = "../../../assets/img/publicidad/".$name;
//$urlActual= URLP.$name;
$uploadOk = 1;
...
if($uploadOk == 0){
 ...
 if(move_uploaded_file($_FILES['file']['tmp_name'],$location)){
    echo '<input type="text" id="copia_reporte" class="form-control disabled" disabled="" value="https://www.gruporivero.com/assets/img/publicidad/'.$name.'">';
 }
}
