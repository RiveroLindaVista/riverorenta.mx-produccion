...
$conne = new Construir();
$ResAccesorios = $conne->get_table_promociones('accesorios');
...
if ($this_subpage=="promociones_accesorios") { $promociones_accesorios="active"; } else{ $promociones_accesorios="active"; }
...
<!-- #Menu -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card" style="text-align: center;">
                        ...
                        <div class="body" onclick="clickImg('_file')">
                            <form action="subirimg.php"  class="dropzone" method="post" enctype="multipart/form-data" id="dropzone">
                                <div class="dz-message" align="center">
                                    <div class="drag-icon-cph">
                                        <i class="material-icons">touch_app</i>
                                    </div>
                                    <h3>Selecciona la imagen de portada del Blog.</h3>
                                    <em>(Recuerda utilizar el formato  <strong>JPG</strong> para crear el Blog.)</em>
                                </div>
                                <div class="fallback">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                HISTORIAL PROMOCIONES ACCESORIOS
                            </h2>
                        </div>
                        <div class="body">
  ...
  function editImg(nombre,id){
    nombre = nombre.replace("accesorios/", '');
    nombre = nombre.replace(".jpg", '');
    $("#nameImg").val(nombre+'_1');
    $("#idImg").val(id);
    $("#modal-edit-img").modal('show');
    document.getElementById('imgArea').innerHTML='<label for="">Imagen Actual de la Promocion</label><br/><img src = "https://d3s2hob8w3xwk8.cloudfront.net/promociones/ofertas/accesorios/'+nombre+'.jpg" style="max-width: 300px;">';
    ...
    if (files) {
        ...
        filereader.onload = function (evt) {
            ...
            $.ajax({
                ...
                success: function(response){
                    if (response == 'ok'){
                        var param={id:id,nombre_nuevo: 'accesorios/'+name+'.jpg'}
