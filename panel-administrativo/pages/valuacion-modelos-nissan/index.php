...
$this_page = "valuacion_modelos_nissan";
if ($this_page == "valuacion_modelos_nissan") {
    $valuacion_modelos = "active";
} else {
    $valuacion_modelos = "active";
}

$conn = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_DB);
$sql = 'SELECT * FROM autometrica_modelos_nissan GROUP BY marca,modelo ORDER BY marca asc';
            ...
            <div class="modal fade bs-example-modal-lg" id="modal-edit-modelo" name="modal-edit-modelo" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div id="progress_view_years" style="margin: 12px;" class="progress">
                            <div id="progressBar"
                            ...
                            <div>
                                <div id="tablaAreaNuevo" style="text-align:center">
                                    ...
                                    <table class="table table-bordered table-striped table-hover no-footer">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="number" id="newAno" /></td>
                                                <td><select id="tipoModeloNuevo">
                                            ...
                                            <tr id="logModal" hidden>
                                                <td id="mensajeModal" colspan="3">Prueba</td>
                                            </tr>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div id="tabla_nuevo_auto" style="text-align:center">
                                    ...
                                    <table class="table table-bordered table-striped table-hover no-footer">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>MARCA</td>
                                                <td><input type="text" id="marca_nuevo" /></td>
                                            </tr>
                                            <tr>
                                                <td>MODELO</td>
                                                <td><input type="text" id="modelo_nuevo" /></td>
                                            </tr>
                                            <tr>
                                                <td>AÑO</td>
                                                <td><input type="number" id="ano_nuevo" /></td>
                                            </tr>
                                            <tr>
                                                <td>TIPO</td>
                                                <td><select id="tipo_nuevo">
                                                        <option value="A">A</option>
                                                        <option value="B">B</option>
                                                        <option value="C">C</option>
                                                        <option value="D">D</option>
                                            ...
                                            <tr>
                                                <td colspan="2"><input class="btn bg-success" type="button" style="border-radius: 7px;background-color:green;color:white;" value="GUARDAR" onclick="saveNuevoAuto()" /></td>
                                            </tr>
                                            <tr id="log_nuevo_Modal" hidden>
                                                <td id="mensaje_nuevo_Modal" colspan="3">Prueba</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    $("#progress_view_years").attr('hidden', true);
