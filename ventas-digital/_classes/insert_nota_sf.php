...
$tipoSend='Prod';
$urlDest='insertar-nota';
	
/*$param='ParentId='.$_POST["id"];
$param.='&OwnerId='.$_POST["OwnerId"];
$param.='&titulo='.$_POST["titulo"];
$param.='&contenido='.$_POST["contenido"];
*/
$param='ParentId=0062S00000zGz5NQAS';
$param.='&OwnerId=005f400000418r9AAA';
$param.='&titulo=Prueba Hventas';
$param.='&contenido=Contenido prueba desde la herramienta de Ventas';
