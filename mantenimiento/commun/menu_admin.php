...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav" style="border-left: 1px solid white;">
            ...
            <ul class="navbar navbar-nav">
                ...
                <li class="nav-item" style="max-width: 30px">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/trabajadores">Personal<span class="sr-only">(current)</span></a>
                </li>
    ...
    <script type="text/javascript">
        ...
        setInterval(() => {
            ...
            let params = {
                func: "ciclo_notificaciones_admin"
            };
            ...
            $.ajax({
                ...
                success: function (resp) {
                    for(let i=0;i<resp.length;i++){
                        $not += "<div class='p-3 m-1' style='border-radius:15px;background-color:#e3e9fb;border: 1px solid #4573F8;cursor:pointer;' onclick='irNotificacion("+resp[i]["id"]+")'>#"+resp[i]["id"]+" - "+resp[i]["log_sistema"]+" <i class='fa fa-share' aria-hidden='true'></i> </div>";
                    }
                    $("#areaNotificaciones").html('<div></div>');
        ...
        function irNotificacion(id){
            ...
            let params = {
                id: id,
                func: "limpiar_notificacion_admin"
            };
