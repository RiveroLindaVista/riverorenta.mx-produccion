        ...
        <div id="ofertaFinal" class="container p-4" hidden>
            ...
            <div id="formCita" class="container p-2" hidden>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <p class="text-white text-center m-0" style="font-size: 1.2em;text-shadow: black 2px 2px 2px;font-family: 'Narrow';position: absolute;"> Agencia Nissan Rivero Contry<br/> Centro de Valuación </p>
                </div>
                <div class="d-flex justify-content-center">
...
/*         $('#filtroMarcas').val(0);
    ...
    function crearCita(){
        ...
        let qrLink = "http://www.google.com/calendar/event?action=TEMPLATE&dates="+fecha.replaceAll("-", "")+"T"+hora.replaceAll(":", "")+"/"+fecha.replaceAll("-", "")+"T"+horadosLink+"&text=Cita+de+Valuacion+Nissan+Rivero&location="+direccion.replaceAll(" ", "+")+"&details=Cita+en+centro+de+valuacion+para+tu+"+modelo.replaceAll(" ", "+")+"+en+la+sucursal+Rivero+Contry";
