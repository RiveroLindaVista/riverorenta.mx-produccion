...
'&00Nf400000UBhZl='.$_POST["preferencia"].
'&00Nf400000UBhZ6='.$_POST["udid"].
'&first_name='.$_POST["nombre"].
'&last_name=-'.
'&email='.$_POST["correo"].
'&00Nf400000UBha3='.$_POST["whatsapp"].
'&00Nf400000UBhYw='.$_POST["ano"].
'&00Nf400000UBhZb='.$_POST["modelo"].
'&00Nf400000UBhZZ='.$_POST["marca"].
'&00Nf400000UBhZW='.$_POST["km"].
